...
위치: [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/Commander.hpp#L69][class Commander]]
...
1. [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/commander.cpp#L266][~commander_main()~]]함수
2. [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/commander.cpp#L283][Commander::main()]] 실행, [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/platforms/px4_module.h#L117][ModuleBase::main()]], [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/platforms/px4_module.h#L181][~ModuleBase::start_command_base()~]]
3. [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/commander.cpp#L4001][~Commander::task_spawn()~]] 실행, [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/platforms/px4_module.h#L152][~ModuleBase::run_trampoline()~]] 실행
4. [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/commander.cpp#L1157][Commander::run()]] 초기화
 - [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/commander.cpp#L1168][Parameter setup]]
 - [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/commander.cpp#L1322][토픽 구독]]
 - Commander에서 사용되는 변수 초기화
5. [[https://github.com/PX4/Firmware/blob/3293fe47f9d33fa83fdac2061695f1d20a2e09fb/src/modules/commander/commander.cpp#L1482][메인 루프]]
 - 파라미터 업데이트
 - 파워버튼 핸들링
 - RC 컨트롤러 토픽 업데이트
 - Offboard 토픽 업데이트 및 타임아웃 설정
 - 텔레메트리 상태 업데이트
 - 시스템 파워 상태 업데이트
...
Commander::run()
{
    ...
    // mavlink, rc, navigator에 의해 내려진 명령을 읽을 수 있는 토픽 구독
...
왜 ~stick_on_counter~ < ~rc_arm_hyst~ ?
